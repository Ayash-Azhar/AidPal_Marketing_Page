...
//       className="bg-white dark:bg-gray-900 shadow-sm fixed top-0 left-0 right-0 z-10 mb-0" // Added mb-0 to prevent margin-bottom gap
//     >
...
//             priority
//           />
//           <span className="text-xl font-bold text-gray-600 dark:text-white">AidPal</span>
//         </Link>
